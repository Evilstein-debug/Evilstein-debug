...
## Tech Stack  
[![My Skills](https://skillicons.dev/icons?i=c,cpp,js,html,css,react,nextjs,tailwind,express,nodejs,vite,postgres,prisma,supabase,mongodb,git,github,docker,npm,pnpm,postman,java,py,vercel,vscode&perline=9)](https://skillicons.dev)
